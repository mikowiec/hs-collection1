> module Net.MilterProtocol where
...
URL: http://cvs.sourceforge.net/viewcvs.py/*checkout*/pmilter/pmilter/doc/milter-protocol.txt?rev=1.6
...
> data Packet = Packet CChar (UArray Int Word8)
>  deriving (Show)

> class (Eq a, Show a) => ByteRep a where
>  byteReps :: [(a,Word8)]
>  toByte :: a -> Word8
>  toByte v = maybe err id (lookup v byteReps)
>   where err = error ("Unknown value: " ++ show v)
>  fromByte :: Word8 -> a
>  fromByte w = case [ v | (v,w') <- byteReps, w == w' ] of [v] -> v; _ -> err
>   where err = error ("Undefined byte: " ++ show w)
...
> data Actions = SMFIF_ADDHDRS | SMFIF_CHGBODY | SMFIF_ADDRCPT | SMFIF_DELRCPT | SMFIF_CHGHDRS | SMFIF_QUARANTINE
>  deriving (Eq,Show)

> instance ByteRep Actions where
>  byteReps = [
>   (SMFIF_ADDHDRS    , 0x01),
>   (SMFIF_CHGBODY    , 0x02),
>   (SMFIF_ADDRCPT    , 0x04),
...
> data Protocols = SMFIP_NOCONNECT | SMFIP_NOHELO | SMFIP_NOMAIL
>       | SMFIP_NORCPT | SMFIP_NOBODY | SMFIP_NOHDRS | SMFIP_NOEOH
>  deriving (Eq,Show)

> instance ByteRep Protocols where
>  byteReps = [
...
> data Command
>  = SMFIC_Abort
>  | SMFIC_Body (UArray Int Word8)
>  | SMFIC_Connect String ProtocolFamily Word16 String
>  | SMFIC_Macro CommandCode [(String,String)]
>  | SMFIC_BodyEob
>  | SMFIC_Helo String
>  | SMFIC_Header String String
>  | SMFIC_Mail String [String]
>  | SMFIC_Eoh
>  | SMFIC_OptNeg Word32 [Actions] [Protocols]
>  | SMFIC_Rcpt String [String]
>  | SMFIC_Quit
>  deriving (Eq,Show)
...
> mapSndOrd8 = map (\(a,b) -> (a, ord8 b))

> instance ByteRep CommandCode where
>  byteReps = mapSndOrd8 [
>   (SMFIC_ABORT   , 'A'),
>   (SMFIC_BODY    , 'B'),
>   (SMFIC_CONNECT , 'C'),
...
> data ProtocolFamily = SMFIA_UNKNOWN | SMFIA_UNIX | SMFIA_INET | SMFIA_INET6
>  deriving (Eq,Show)

> instance ByteRep ProtocolFamily where
>  byteReps = mapSndOrd8 [
>   (SMFIA_UNKNOWN , 'U'),
>   (SMFIA_UNIX    , 'L'),
>   (SMFIA_INET    , '4'),
...
>  | SMFIR_Accept
>  | SMFIR_ReplBody (UArray Int Word8)
>  | SMFIR_Continue
>  | SMFIR_Discard
>  | SMFIR_AddHeader String String
>  | SMFIR_ChgHeader Word32 String String
>  | SMFIR_Progress
>  | SMFIR_Quarantine String
>  | SMFIR_Reject
>  | SMFIR_TempFail
>  | SMFIR_ReplyCode Int String -- "Nxx string"
>  | SMFIR_OptNeg Word32 [Actions] [Protocols]
>  deriving (Eq,Show)
...
> instance ByteRep ResponseCode where
>  byteReps = mapSndOrd8 [
>   (SMFIR_ADDRCPT    , '+'),
>   (SMFIR_DELRCPT    , '-'),
>   (SMFIR_ACCEPT     , 'a'),
